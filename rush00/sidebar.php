...
<div class=sidebar>
    ...
    <ul class=ulside ><a class=lisidebar href='create_category.php'>Create Category</a></ul>
    <ul class=ulside ><a class=lisidebar href='del_category.php'>Delete Category</a></ul>
    <ul class=ulside ><a class=lisidebar href='upgrade_user.php'>Upgrade User</a></ul>
